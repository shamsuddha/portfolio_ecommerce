...
export class VerticalNavComp implements OnInit {
  ...
  ngOnInit(): void {
    this.menuItemList = [
      ...
      { id: '5', label: 'Category Setup', icon: 'fa-solid fa-house', link: '/authenticated/category' },
      { id: '6', label: 'Sub Category Setup', icon: 'fa-solid fa-house', link: '/authenticated/sub-category' },
      { id: '7', label: 'Unit Setup', icon: 'fa-solid fa-house', link: '/authenticated/unit' },
      { id: '8', label: 'Brand Setup', icon: 'fa-solid fa-house', link: '/authenticated/brand' },
      { id: '9', label: 'Model Setup', icon: 'fa-solid fa-house', link: '/authenticated/model' },
      { id: '10', label: 'Product Setup', icon: 'fa-solid fa-house', link: '/authenticated/product' },
      { id: '11', label: 'Order Setup', icon: 'fa-solid fa-house', link: '/role-setup' },
      { id: '12', label: 'Review', icon: 'fa-solid fa-house', link: '/role-setup' },
      { id: '13', label: 'Wishlist', icon: 'fa-solid fa-house', link: '/role-setup' },
